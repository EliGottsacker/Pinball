...
const bool ledsByScore = false;//will cause score to set how many leds
...
void ReleaseBall() {
  ...
  delay(1500);
  servo1.write(0);
  Serial.println("LOGIC: Motor triggered");
}
