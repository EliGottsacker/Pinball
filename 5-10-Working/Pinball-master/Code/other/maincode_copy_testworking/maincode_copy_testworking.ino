...
const int popBumperThree = A2; // the number of the popBumper pin
...
if (getChar == 1) {
setstring = "1"+setstring;
}
if (getChar == 2) {
setstring = "2"+setstring;
}
if (getChar == 3) {
setstring = "3"+setstring;
}
if (getChar == 4) {
setstring = "4"+setstring;
}
if (getChar == 5) {
setstring = "5"+setstring;
}
if (getChar == 6) {
setstring = "6"+setstring;
}
if (getChar == 7) {
setstring = "7"+setstring;
}
if (getChar == 8) {
setstring = "8"+setstring;
}
if (getChar == 9) {
setstring = "9"+setstring;
}*/
